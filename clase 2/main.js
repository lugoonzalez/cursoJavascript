var selection = parseInt(prompt("Combo 1: frutillas y peras. Combo 2: arándanos y cerezas. Combo 3: manzanas y kiwis. Ingresa el número del combo que quieres comprar:"));
var neighborhood;
var shipping; 
var price; 
...
if (selection == 1) {
    ...
    neighborhood = prompt("Barrios disponibles para entregas: San Telmo, Barracas, Constitución, Congreso, Monserrat. Ingresa el nombre de tu barrio:");
} else if (selection == 2) {
    price = 450;
